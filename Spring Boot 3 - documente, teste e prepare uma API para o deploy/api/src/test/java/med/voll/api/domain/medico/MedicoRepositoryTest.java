...
@DataJpaTest
@AutoConfigureTestDatabase(replace = AutoConfigureTestDatabase.Replace.NONE) /*para o spring não substituir as config
do meu banco de dados pelo banco em memória*/
